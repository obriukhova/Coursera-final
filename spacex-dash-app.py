...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_site['count'] = 1
        fig = px.pie(filtered_df_site, values='count', 
        names='class', 
...
def get_cat_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        y="class",
        color="Booster Version Category",
        title="Payload vs. Success Outcome at {}".format(entered_site),
        labels={"class": "Launch Outcome (0=Fail, 1=Success)"})
        return fig
